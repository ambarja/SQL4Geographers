<img alt="SpatialSQL" src="./icon/sp_sql.png" align="right" width = 14%/>
...
# Objetivos:
 ...
 - Importar datos a una base de datos SQLite y trabajar con SpatialLite
 - Comprender la diferencia entre consultar de atributos y consultas de geometría
 - Ver tablas y vistas espaciales con QGIS
 - Crear capas o tablas virtuales en QGIS con comandos SQL 
